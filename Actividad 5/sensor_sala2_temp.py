...
def on_connect(client, userdata, flags, rc, properties=None):
    print("Sensor sala2/temp conectado con código %s" % rc)
...
client = paho.Client(client_id="sensor_sala2_temp", userdata=None, protocol=paho.MQTTv311)
...
while True:
    if running:
        ...
        client.publish("lan/sala2/sensor/temp", payload=str(temp), qos=1)
        print("Publicado temp:", temp)
    time.sleep(2)
